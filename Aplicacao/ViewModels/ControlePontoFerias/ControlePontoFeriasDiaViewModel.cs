...
{
    public class ControlePontoFeriasDiaViewModel
    {
        ...
        public List<ControlePontoFeriasUnidadeApoioViewModel> UnidadesApoio { get; set; }

        public ControlePontoFeriasDiaViewModel()
        {
        ...
        public void CalcularAdicionalNoturno()
        {
            var hoje = DateTime.Now;
            var horarioEntrada = !string.IsNullOrEmpty(HorarioEntrada) ? TimeSpan.Parse(HorarioEntrada) : TimeSpan.Parse("00:00");
            var horarioSaida = !string.IsNullOrEmpty(HorarioSaida) ? TimeSpan.Parse(HorarioSaida) : TimeSpan.Parse("00:00");
        ...
        public void AdicionarUnidadesApoio(ControlePontoFeriasUnidadeApoioViewModel unidadeApoio)
        {
            if (UnidadesApoio == null)
                UnidadesApoio = new List<ControlePontoFeriasUnidadeApoioViewModel>();
