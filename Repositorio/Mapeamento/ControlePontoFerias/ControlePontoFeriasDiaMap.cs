...
{
    public class ControlePontoFeriasDiaMap : ClassMap<ControlePontoFeriasDia>
    {
        public ControlePontoFeriasDiaMap()
        {
            Table("ControlePontoFeriasDia");
            LazyLoad();
            ...
            HasMany(x => x.UnidadesApoio)
                .Table("ControlePontoFeriasUnidadeApoio")
                .KeyColumn("ControlePontoFeriasDia")
                .Component(c => {
