...
function editarEndereco(id) {
    ...
    if (enderecoEmEdicao.Cidade.Estado && Object.keys(enderecoEmEdicao.Cidade.Estado).length)
...
function atualizarEnderecos(enderecos) {
    showLoading();
    $.post("/Condomino/AtualizarEnderecos", { enderecos })
        .done((response) => {
...
function saveAddress() {
    ...
    showLoading();
    $.ajax({
        url: "/Condomino/AdicionarEndereco",
        datatype: "JSON",
        type: "GET",
