...
namespace Portal.App_Helpers
{
    public static class HtmlHelperExtensions
    {
        ...
        public static IHtmlString RouteIf(this HtmlHelper helper, string value, string attribute)
        {
            ...
            var hasController = !string.IsNullOrEmpty(value) && value.Equals(currentController, StringComparison.InvariantCultureIgnoreCase);
            var hasAction = !string.IsNullOrEmpty(value) && value.Equals(currentAction, StringComparison.InvariantCultureIgnoreCase);
