...
{
    public class MonthlyContractPaymentException : Exception
    {
        public MonthlyContractPaymentException(string message) : base(message)
        {
            Message = FriendlyMessage(message);
        }

        public MonthlyContractPaymentException(string message, Exception inner) : base(message, inner)
        {
            Message = FriendlyMessage(message, inner);
        }

        protected MonthlyContractPaymentException(System.Runtime.Serialization.SerializationInfo info,
